...
<section class=" overflow-hidden">
    <div class="flex min- overflow-hidden">
        <div class="relative flex-1 hidden w-0 overflow-hidden lg:block">
            <img class="absolute inset-0 object-cover rounded shaldow-lg w-full h-full bg-black" src="https://source.unsplash.com/random/1700x1700" alt=""/>
        </div>
        <div class="flex flex-col justify-center bg-slate-100 flex-1 px-4 py-12 overflow-hidden sm:px-6 lg:flex-none lg:px-20 xl:px-24">
            <div class="w-full max-w-xl mx-auto lg:w-96">
                <div>
                    <a href="/" class="text-blue-600 text-medium">News App</a>
